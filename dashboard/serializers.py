...
class AdminHouseAdverstisementSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        read_only_fields = ['id', 'owner', 'title','description','category', 'rent','bill_time', 'advance', 'area','bedrooms','bathrooms','balcony' ,'avaiable_from' ,'contact_phone','contact_email', 'is_booked', 'created_at', 'updated_at']